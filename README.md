...
Aşağıdaki problem ifadesine göre bir sınıf diyagramı tasarladık. Nesne Yönelimli Programlamanın ilkelerini ve sınıflar arası ilişki durumlarını kullanmaya çalıştık. (Encapsulation, Inheritance, Polymorphism, Abstraction)
